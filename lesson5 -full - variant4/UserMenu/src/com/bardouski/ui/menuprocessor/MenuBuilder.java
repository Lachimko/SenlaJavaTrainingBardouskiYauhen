...
import com.bardouski.config.IPropertiesHolder;
...
public class MenuBuilder implements IMenuBuilder {
	...
	public MenuBuilder(Facade facade, IPropertiesHolder propertiesHolder) {
		this.facade = facade;

		if (propertiesHolder != null) {
			this.propertiesHolder = (AutoManagmentPropertiesHolder) propertiesHolder;
		}
	}
